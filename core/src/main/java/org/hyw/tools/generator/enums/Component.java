...
public enum Component {
	...
	// 中间件/插件
	REDIS, DUBBO, ZIPKIN, SKYWALKING, ZOOKEEPER, NACOS, ROCKETMQ, KAFKA, ELASTICSEARCH, SENTINEL, GATEWAY, OPENAPI, OPENFEIGN,
	
	// 业务框架/应用层
	SPRINGBOOT, SPRINGCLOUD, SPRINGMVC, SWAGGER2, THYMELEAF, SHIRO, SPRINGSECURITY, JWT, 
