...
import ${rootPackage!}.${projectName!}<#if moduleName?has_content>.${moduleName!}</#if>.utils.SpringUtils;

import ${rootPackage!}.${projectName!}<#if moduleName?has_content>.${moduleName!}</#if>.utils.HttpUtils;
