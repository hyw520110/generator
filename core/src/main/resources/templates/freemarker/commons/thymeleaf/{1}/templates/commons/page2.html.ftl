...
<table class="ui-pg-table ui-common-table ui-pager-table ">
		<tbody>
			<tr>
					...
					<table class="ui-pg-table navtable ui-common-table">
						<tbody>
							<tr>
								...
								<td class="ui-pg-button ui-state-disabled" title=""><span
				...
				<td id="grid-pager_center" style="white-space: pre;" align="center">
					<table class="ui-pg-table ui-common-table ui-paging-pager">
						<tbody>
							<tr>
								<td id="first_grid-pager" th:unless="${page.isFirstPage!}"
								...
								<td id="input_grid-pager" dir="ltr">Page <input
									class="ui-pg-input ui-corner-all" size="2" maxlength="7"
									value="0" role="textbox" type="text" /> of <span
