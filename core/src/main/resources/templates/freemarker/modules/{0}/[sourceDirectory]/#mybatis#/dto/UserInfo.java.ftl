...
public class UserInfo extends BaseModel<UserInfo> {
	 ...
	 * 所在城市代码
	 */
	@Schema(name = "city", description = "所在城市代码")
	private String city;
	/**
	 * 注册时间
	 */
	@Schema(name = "joinTime", description = "注册时间")
	...
	@Schema(name = "userStatus", description = "用户状态 'N' 正常 'L' 锁定")
	private String userStatus;

	@Schema(name = "userRoles", description = "用户角色列表")
