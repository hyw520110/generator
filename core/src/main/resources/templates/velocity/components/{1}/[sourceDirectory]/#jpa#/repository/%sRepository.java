...
@Repository
public interface ${repositoryName} #if(${superRepositoryClass}) extends ${StringUtils.getClassName(${superRepositoryClass})} #else extends CrudRepository<${entityName},${table.primaryKeyField.fieldType.type}> #end{
